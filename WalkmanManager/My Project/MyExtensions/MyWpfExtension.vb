...
Namespace My
    ...
    Module MyWpfExtension
        Private _sComputer As New ThreadSafeObjectProvider(Of Global.Microsoft.VisualBasic.Devices.Computer)
        Private _sUser As New ThreadSafeObjectProvider(Of Global.Microsoft.VisualBasic.ApplicationServices.User)
        Private _sWindows As New ThreadSafeObjectProvider(Of MyWindows)
        Private _sLog As New ThreadSafeObjectProvider(Of Global.Microsoft.VisualBasic.Logging.Log)
        ''' <summary>
        ''' 返回正在运行的应用程序的应用程序对象
        ''' </summary>
        ...
        Friend NotInheritable Class MyWindows
            ...
            Private Shared Function Create__Instance__(Of T As {New, Global.System.Windows.Window})(ByVal instance As T) As T
                If Instance Is Nothing Then
                    If _sWindowBeingCreated IsNot Nothing Then
                        ...
                        End If
                    Else
                        _sWindowBeingCreated = New Global.System.Collections.Hashtable()
                    End If
            ...
            Public Sub New()
                MyBase.New()
            End Sub
            <Global.System.ThreadStatic()> Private Shared _sWindowBeingCreated As Global.System.Collections.Hashtable
